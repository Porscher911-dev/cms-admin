...
import { AttendanceReminder } from "@/components/layout/attendance-reminder"
...
export default function DashboardLayout({
  ...
  useEffect(() => {
    ...
    if (role === "DIRECTOR") {
      ...
      const allowedPaths = ["/workspace", "/attendance", "/tasks", "/reports", "/calendar", "/settings", "/projects", "/company", "/expenses", "/chat"]
